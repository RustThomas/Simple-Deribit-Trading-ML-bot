...
If you'd wish to tip me for these measly lines of code, you may do so by using my [referal link for metamask](https://link.metamask.io/rewards?referral=CMBA5F) or at ```0x15156ba57acce78843367f0a5816b52e06870ef5```(Ethereum).
